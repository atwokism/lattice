 ...
 *   });
     ...
     * Typically used with {@link api/ng.directive:ngTransclude ngTransclude}.
 ...
 * served document.  You can change these by setting your own
 * custom {@link ng.$sceDelegateProvider#methods_resourceUrlWhitelist whitelists}
 * and {@link ng.$sceDelegateProvider#methods_resourceUrlBlacklist blacklists} for matching such URLs.
 *
...
function $SceProvider() {
  ...
  this.$get = ['$parse', '$sniffer', '$sceDelegate', function(
     ...
     *
     * @description
     * Converts Angular {@link guide/expression expression} into a function.  This is like {@link ng.$parse $parse}
     * and is identical when the expression is a literal constant.  Otherwise, it
 ...
 * element in a secure way.  By default, the innerHTML-ed content will be sanitized using
 * the {@link ngSanitize.$sanitize $sanitize} service.  To utilize this functionality, ensure that `$sanitize`
